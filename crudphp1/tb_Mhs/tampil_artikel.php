                ...
                <td>
                    <div class='button-container'>
                        <div class='button-wrapper'>
                            <a class='edit-button' href='edit_artikel.php?id=".$row['nim']."'>Edit</a>
                            <a class='delete-button' href='delete_artikel.php?id=".$row['nim']."'>Hapus</a>
                        </div>
                    </div>
                </td>
            </tr>";
