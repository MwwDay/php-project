...
if (mysqli_num_rows($result) > 0) {
    echo "<table>
            <tr>
                ...
                <th bgcolor='yellow'>Nama Dosen</th>
                <th bgcolor='yellow'>Jenis Kelamin</th>
                <th bgcolor='yellow'>Alamat</th>
                <th bgcolor='yellow'>Nomor Telepon</th>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>
                ...
                <td>
                    ...
                    <a class='edit-button' href='edit_artikel.php?id=".$row['kode_dosen']."'>Edit</a>
                    <a class='delete-button' href='delete_artikel.php?id=".$row['kode_dosen']."'>Hapus</a>
                        </div>
                    </div>
                </td>
            </tr>";
